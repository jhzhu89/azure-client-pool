...
import { type BaseClientManager } from "./base-manager.js";
import {
  type AuthenticationStrategy,
  ApplicationAuthStrategy,
  DelegatedAuthStrategy,
} from "../providers/strategies.js";
...
import {
  ...
  createJwtHandler,
} from "../injection/factory-functions.js";
import { type RequestMapper } from "../utils/request-mapper.js";
...
{
  constructor(
    private clientManager: BaseClientManager<TClient, unknown, TOptions>,
...
export async function createClientProvider<TClient, TOptions = void>(
  ...
  let clientManager: BaseClientManager<TClient, unknown, TOptions>;
